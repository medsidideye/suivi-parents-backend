...
# ⚠️ Les routes ci-dessous, avec {id_eleve} dans le chemin, doivent impérativement
# rester APRÈS "/eleves", "/eleves/recherche" et "/classes/{id_classe}/eleves"
# ci-dessus — FastAPI teste les routes dans leur ordre de déclaration, donc une route
# à paramètre placée avant intercepterait par erreur des chemins comme "/recherche"
# en essayant de le convertir en identifiant numérique.
